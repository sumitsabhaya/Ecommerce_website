    ...
    <div className='home'>
        ...
        <div className='banners'>
          <div className='container'>
            <div className='left_box'>
              <div className='box'>
                <img src='image/banner1.avif' ></img>
              </div>
              <div className='box'>
                <img src='image/banner2.avif' ></img>
              </div>
            </div>
            <div className='right_box'>
              <div className='top'>
                <img src='image/Multi-Banner-3.webp'></img>
                <img src='image/Multi-banner-4.avif'></img>
              </div>
              <div className='bottom'>
                <img src='image/Multi-Banner-5.webp'></img>
              </div>
            </div>
          </div>
        </div>
